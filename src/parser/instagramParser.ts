export function extractUsernames(html: string): string[] {
  ...
  // ─────────────────────────────────────────────
  // FORMATO 1: link diretto al profilo
  // Usato da followers_1.html, following.html, ecc.
  //   <a href="https://www.instagram.com/username">
  //   <a href="https://www.instagram.com/_u/username">  (variante con prefisso /_u/)
  // ─────────────────────────────────────────────

  const anchorRegex =
    /href=["']https?:\/\/(?:www\.)?instagram\.com\/(?:_u\/)?([a-zA-Z0-9._]+)\/?["']/gi;
  ...
  //   <td>Nome utente</td><td>VALORE</td>
  // ─────────────────────────────────────────────
